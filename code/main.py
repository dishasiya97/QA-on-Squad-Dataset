...
tf.app.flags.DEFINE_integer("max_pool", 4, "maximum pooling size for answer decoder.")
tf.app.flags.DEFINE_integer("num_iterations", 4, "number of iterations for answer decoder.")
